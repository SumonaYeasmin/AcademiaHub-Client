        ...
        <div className="flex flex-col justify-center my-8 shadow-lg rounded-lg p-8 max-w-md mx-auto">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div>
                    ...
                    <input type="email" {...register("email", { required: true })} id="email" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" placeholder="Enter your email"
                ...
                <div>
                    ...
                    <input type="password" {...register("password", { required: true })} id="password" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" placeholder="Enter your password" />{errors.password && <span className='text-red-600'>password is required</span>}
                </div>

...
const Feedback = () => {
    ...
    return (
        <div className="container mx-auto py-10">
            <h2 className="text-3xl md:text-4xl font-semibold mb-5 text-center text-teal-600 italic">
                Student Feedback
            </h2>
            <Swiper
                    ...
                    <SwiperSlide key={comment._id}>
                        <div className="flex flex-col md:flex-row items-center p-3 bg-gray-50 border border-gray-200 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
                            ...
                            <div className="md:w-[50%] pl-0 md:pl-6">
                                <h3 className="text-2xl md:text-4xl py-2 font-semibold  bg-gradient-to-r from-teal-500 via-blue-500 to-green-600 text-transparent bg-clip-text md:mb-3">
                                    {comment.title}
                                </h3>
                                <p className="text-lg font-medium md:text-xl text-transparent bg-gradient-to-r from-indigo-400 via-cyan-500 to-fuchsia-500 bg-clip-text leading-relaxed md:mb-2 italic">

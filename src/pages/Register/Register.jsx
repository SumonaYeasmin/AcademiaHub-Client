        ...
        <div className="flex flex-col justify-center my-20 bg-white shadow-lg rounded-lg p-8 max-w-md mx-auto border">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 ">
                ...
                <div>
                    ...
                    <input type="text" id="name" {...register("name", { required: true })} className="w-full px-4 py-2 text-black bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-400" placeholder="Enter your name" />
                ...
                <div>
                    ...
                    <input type="photoUrl" id="photoURL" {...register("photoUrl", { required: true })} className="w-full bg-white px-4 py-2 text-black border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-400" placeholder="Enter your photo URL" />
                ...
                <div>
                    ...
                    <input type="text" id="email" {...register("email", { required: true })} className="w-full px-4 py-2 text-black bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-400" placeholder="Enter your email" />
                ...
                <div className="relative">
                    ...
                    })} className="w-full px-4 py-2 text-black bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-400" placeholder="Enter your password" />
                ...
                {/* Submit Button */}
                <button className="w-full bg-teal-500 hover:bg-teal-600 text-white font-bold py-2 px-4 rounded-lg transition duration-300"
                >Register </button>
            ...
            <p className="text-gray-600 mt-4 text-center">
                ...
                <Link to='/signIn'><span className="text-teal-700 font-bold text-base hover:underline cursor-pointer">
                    Login
                </span></Link>
            </p>
        </div>
